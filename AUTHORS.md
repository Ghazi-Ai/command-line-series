...
الأدوات الموثقة في سجلات إعداد المشروع: Claude Opus 4.8 وChatGPT
5.6 في أوضاع Luna وSol. لا تُفهم أسماء الأدوات على أنها نسبة تأليف.

وثّق صاحب المشروع أن جميع صور الأغلفة وُلّدت بالكامل عبر ChatGPT
Images من OpenAI، اعتمادًا على أوصاف نصية أصلية ودون مدخلات بصرية
خارجية، ثم أضيفت العناوين والنصوص والهوية والتنسيق النهائي بأداة
Typst. تبقى الصور مستثناة من عرض CC BY-SA 4.0، فلا تمنح رخصة المحتوى
حق إعادة استخدامها تلقائيًا.

---

© 2026 المهندس غازي السيف. يعرض المحتوى العام المحدد في
[`LICENSES/README.md`](LICENSES/README.md) تحت **CC BY-SA 4.0**،
والشيفرة الأصلية المحددة تحت MIT، من دون ادعاء حقوق في مواد لا يملكها.
