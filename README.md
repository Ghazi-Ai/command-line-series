...
| 6 | 🔷 **رُوحٌ في الآلة** | حكاية يونِكس — كتابٌ أدبيّ للعامّة | ✅ مكتمل — 13 فصلًا · 118 ص |

> كلُّ كتابٍ يُبنى PDF كاملًا بغلافيه الأمامي والخلفي مدموجَين. المجموع 2,931 صفحة.
...
لم يكتمل توثيق الأداة وشروط الاستخدام لكل أصل بصري؛ لذلك استُبعدت
صور الأغلفة من عرض الترخيص الجديد إلى أن يثبت نطاق حقوقها.
...
الأطراف الثالثة تحت رخص أصحابها. لا تشمل الرخصة الملفات الداخلية ولا
الأصول المستثناة.
...
السيف — أبو هيثم** — `https://github.com/Ghazi-Ai/command-line-series/issues`

### الإفصاح عن استخدام الذكاء الاصطناعي

هذا المشروع من فكرة غازي السيف وتصميمه وإشرافه. استُخدمت أدوات الذكاء
الاصطناعي في توليد مسودات النصوص والمساهمة في كتابة المحتوى الأساسي
للكتب. وتولّى غازي توجيه العمل، وبناء هيكله، وتنظيم مادته، ومراجعتها
وتدقيقها، واختيار ما يُعتمد منها، واعتماد النسخة المنشورة، ويتحمّل
مسؤولية القرارات التحريرية والمحتوى النهائي. لا تُنسب أدوات الذكاء
الاصطناعي بوصفها مؤلفًا أو مؤلفًا مشاركًا. تفاصيل الأدوات في
