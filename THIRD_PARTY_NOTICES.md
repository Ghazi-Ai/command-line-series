...
استُخدمت أدوات توليد الصور في الفن الأساسي للأغلفة. لم توثق الملفات
المتاحة الأداة والنموذج وشروط الاستخدام لكل صورة توثيقًا يكفي
لإدراجها في عرض الترخيص الجديد؛ لذلك استُبعدت مسارات الصور المحددة في
`LICENSES/README.md` إلى أن يكتمل إثبات مصدرها ونطاق حقوقها. يسجل
[`docs/COVER-RIGHTS-AUDIT.md`](docs/COVER-RIGHTS-AUDIT.md) البيانات
الناقصة والقرار المطلوب لكل كتاب. لا يثبت الاستثناء وحده حق الاستخدام
التجاري.
