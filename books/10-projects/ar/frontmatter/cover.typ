...
#page(width: 148mm, height: 210mm, margin: 0pt, header: none, footer: none, numbering: none, {
  ...
  place(top + center, dy: 6mm, block(width: 100%, {
    set align(center)
    text(font: FONT.displayAr, size: 34pt, weight: 800, fill: rgb("#145A54"), dir: ltr)[10+]
    v(1.5mm)
    text(font: FONT.displayAr, size: 26pt, weight: 800, fill: rgb("#145A54"))[
      مشاريع كبرى \
      من الطرفية
    ]
    v(2.5mm)
