// صفحة العنوان — «مِن الصِّفر إلى العِفريت» (BSD)
#import "/lib/theme.typ": COLOR, FONT

#page(header: none, footer: none, numbering: none, {
  set align(center)
  v(1.4fr)
  text(dir: ltr, font: FONT.mono, size: 11pt, fill: COLOR.primary, weight: 600)[ghazi\@freebsd:\~ \$]
  v(2.4fr)
  ...
  text(font: FONT.bodyAr, size: 13.5pt, fill: COLOR.ink, weight: 600)[
    الدليل الشامل إلى FreeBSD وعالم BSD
  ]
  v(13pt, weak: true)
  ...
  text(font: FONT.bodyAr, size: 9pt, fill: COLOR.muted)[
    سلسلة سطر الأوامر · الكتاب الرابع · النسخة العربية
  ]
  v(0.7fr)
})
