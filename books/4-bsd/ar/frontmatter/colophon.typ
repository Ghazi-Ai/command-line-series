// صفحة الحقوق — «مِن الصِّفر إلى العِفريت» (BSD)
...
#page(header: none, footer: none, numbering: none, {
  ...
  text(weight: 700, size: 11pt)[مِن الصِّفر إلى العِفريت]
  linebreak()
  text(fill: COLOR.muted)[الدليل الشامل إلى FreeBSD وعالم BSD — من سلسلة سطر الأوامر (الكتاب الرابع)]
