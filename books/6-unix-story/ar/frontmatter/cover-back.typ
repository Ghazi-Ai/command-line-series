...
#page(width: 148mm, height: 210mm, margin: 0pt, header: none, footer: none, numbering: none, {
  ...
  place(top + center, dy: 40mm, block(width: 80%, {
    ...
    text(size: 10pt)[هذه حكايةُ يونِكس: الفكرةِ التي امتدت إلى الخوادم والحواسيب والهواتف، مباشرةً في بعض الأنظمة، وتأثيرًا ومعاييرَ في أنظمةٍ أخرى. رحلةٌ في نصف قرنٍ من مختبرات بِل إلى البنى التي تعمل فوقها خدمات العصر.]
    v(9mm)
