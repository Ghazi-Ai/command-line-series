...
#page(header: none, footer: none, numbering: none, {
  set align(center)
  v(1.4fr)
  text(dir: ltr, font: FONT.mono, size: 10.5pt, fill: COLOR.primary, weight: 600)[
  ...
  v(24pt, weak: true)
  text(font: FONT.bodyAr, size: 13pt, fill: COLOR.ink, weight: 600)[
  ...
  text(font: FONT.bodyAr, size: 9pt, fill: COLOR.muted)[
    سلسلة سطر الأوامر · الكتاب الخامس · النسخة العربية
  ]
  v(0.7fr)
})
