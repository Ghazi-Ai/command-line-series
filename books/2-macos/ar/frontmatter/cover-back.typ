...
#page(width: 148mm, height: 210mm, margin: 0pt, header: none, footer: none, numbering: none, {
  ...
  place(top + center, dy: 38mm, block(width: 80%, {
    ...
    text(size: 10pt)[تحت واجهةِ ماك الأنيقةِ يسكنُ نظامٌ يونِكسيٌّ عريق. هذا الكتابُ يفتحُ لك بابَ الطرفيّة على macOS، فتكتشفُ القوّةَ الكامنةَ التي لا تُظهرها النوافذُ الجميلة.]
    v(6mm)
