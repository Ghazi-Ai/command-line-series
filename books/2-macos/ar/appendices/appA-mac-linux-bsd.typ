...
الفرقُ الجوهريّ أنّ لِينُكس هجر أدوات BSD القديمة (`ifconfig`, `route`) إلى حزمة `iproute2` وأمرها الموحّد `ip`، بينما ماك وBSD ما زالا على `ifconfig` الكلاسيكيّ. ولماك زيادةً أداةٌ رسوميّةُ الخلفيّة اسمها `networksetup` تضبط إعدادات الشبكة كما تفعلها لوحة الإعدادات.
...
#note[
  للتوسّع (`\+`, `\?`, `\|`) نسخةُ GNU تفهمها بالإفلات في النمط الأساسيّ، وBSD لا تفهمها إلّا بعَلَم `-E`. العَلَمُ `-E` مدعومٌ في النظامين اليوم فاعتَدْه؛ أمّا `-r` القديم فحصريٌّ لـ GNU.
]
