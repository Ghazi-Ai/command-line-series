...
الكونسول القديم يعطيك نافذةً واحدةً لصدفةٍ واحدة. Windows Terminal يعطيك نافذةً تحتضن *كلَّ* صدفك في تبويباتٍ وألواح، ويحفظ ذوقك كلَّه في ملفِّ إعدادٍ واحد. هذا هو الفرق العمليّ: لا أن الحروف أجمل فحسب، بل أنّ النافذة صارت قابلةً للتأثيث.
...
الاقتراحُ الباهت الذي يظهر بعد مؤشّرك — الذي عرفتَه هناك — يأتيه من *مصدر* تختاره. المصادر أربعة:
