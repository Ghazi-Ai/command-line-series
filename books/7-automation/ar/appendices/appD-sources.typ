...
- نظرة PowerShell الرسمية ووصفه صدفةً ولغة أتمتة عابرة للأنظمة:
...
- دليل `jq` الرسمي لقراءة JSON وإنشائه:
  `jqlang.org/manual/`
- موقع ShellCheck الرسمي ودليل قواعده:
  `shellcheck.net`

#section[التحكم بالإصدارات]

- مرجع Git الرسمي للأوامر والمفاهيم:
  `git-scm.com/docs`
- كتاب Pro Git المنشور ضمن موقع المشروع الرسمي:
  `git-scm.com/book`

#section[التشغيل البعيد والجدولة]

- صفحات OpenSSH الرسمية للأمر `ssh` والتحقق من مفاتيح المضيف
  والتنفيذ البعيد:
  `man.openbsd.org/ssh`
- توثيق مؤقتات systemd الرسمي:
  `freedesktop.org/software/systemd/man/systemd.timer.html`
- توثيق Microsoft لمجدول المهام وPowerShell، بحسب إصدار ويندوز
...
- مرجع GitHub الرسمي للاستخدام الآمن للأتمتة: أقل صلاحية، ومنع
