// صفحة الغلاف الأمامي — الفن الجاهز مع العنوان مطبوعًا فوقه
...
#page(width: 148mm, height: 210mm, margin: 0pt, header: none, footer: none, numbering: none, {
  ...
  place(top + left, image(
    "/books/7-automation/ar/assets/cover-front.png",
    width: 148mm,
    height: 210mm,
  ))
  ...
  place(top + center, dy: 15mm, block(width: 100%, {
    ...
    v(5mm)
    text(font: FONT.bodyAr, size: 12pt, weight: 600, fill: rgb("#176B63"))[
