#!/usr/bin/env python3
# LEGACY: مولّد هيكل تاريخي لكتاب لينكس الأول. الكتب الحالية مكتملة، ولا
# يُستخدم هذا الملف لإعادة توليدها أو استبدال ملفاتها المعتمدة.
# -*- coding: utf-8 -*-
"""
مولّد هيكل الكتاب «من الصِّفر إلى الجذر».
يُنشئ ملفّات الفصول الناقصة (لا يمسّ الموجود)، ويولّد:
  - books/1-linux/ar/_contents.typ  (تسلسل الأجزاء والفصول والملاحق للبناء)
