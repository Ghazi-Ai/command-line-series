...
#let rights-block(technical: false) = {
  ...
  v(0.35em)
  [استُخدمت أدوات الذكاء الاصطناعي في توليد مسودات النصوص والمساهمة
  في كتابة المحتوى الأساسي للكتب. وتولّى غازي توجيه العمل وبناء
  هيكله وتنظيم مادته ومراجعتها وتدقيقها واختيار ما يُعتمد منها
  واعتماد النسخة المنشورة، ويتحمّل مسؤولية القرارات التحريرية
  والمحتوى النهائي. لا تُنسب أدوات الذكاء الاصطناعي بوصفها مؤلفًا أو
  مؤلفًا مشاركًا.]
